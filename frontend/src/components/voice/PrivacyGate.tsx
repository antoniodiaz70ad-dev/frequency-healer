...
export default function PrivacyGate({ transcriptionEnabled, aiEnabled, processingVersion, children }: { transcriptionEnabled: boolean; aiEnabled: boolean; processingVersion: string; children: ReactNode }) {
  ...
  return <div className={styles.workspace}><h1>Sesión guiada · tu privacidad</h1><section><h2>Antes de empezar</h2>
    <p>Puedes completar toda la sesión escribiendo. El micrófono es opcional y solo se activa cuando inicias una captura; no es necesario para continuar.</p>
